...
d.dialogue = {
 ...
 'startchoices': [
                  ["um... I'm Not sure", 'notsure'],
                  ['Who are you?', 'who'],
                  ['Screw this old guy. I have things to do.', 'exit'],
                  ['another choice', 'exit'],
  ],
              'notsure': 'The old man laughs at you. He asks:\n    "Why would you say that?"\n\n',
 'notsurechoices': [
                    ['you look at your watch and say "no thanks I have to get going" you walk out into the hall',
                     'exit'],
